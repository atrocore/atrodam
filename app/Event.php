...
class Event extends AbstractEvent
{
    ...
    protected function insertDbData()
    {
        ...
        // insert video type
        $this->execute("INSERT INTO `asset_type` (`id`, `name`, `deleted`, `created_at`, `modified_at`, `created_by_id`, `modified_by_id`) VALUES ('video', 'Video', 0, '2021-03-01 00:00:00', '2021-03-01 00:00:00', '1', NULL)");
        $this->execute("INSERT INTO `validation_rule` (`id`, `name`, `deleted`, `created_at`, `modified_at`, `created_by_id`, `modified_by_id`, `asset_type_id`, `type`, `ratio`, `pattern`, `min`, `max`, `color_depth`, `color_space`, `min_width`, `min_height`, `extension`, `mime_list`, `is_active`, `validate_by`) VALUES ('603d0f0435374022f', 'Extension', 0, '2021-03-01 15:57:56', '2021-03-01 15:57:56', 1, 'Extension', NULL, 'List', NULL, 0, NULL, NULL, NULL, NULL, NULL, '[\"mp4\",\"webm\",\"ogv\"]', NULL, '1', NULL, 'video'),('603d0f4e8bd0a907e', 'Mime', 0, '2021-03-01 15:59:10', '2021-03-01 15:59:10', 1, 'Mime', NULL, 'List', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '[\"video\\/mp4\",\"video\\/webm\",\"video\\/ogg\"]', '1', NULL, 'video')");
    }
