...
Search and filtering allow you to quickly focus on the records you want to see. These sections are automatically available on each entity [list](./views-and-panels-dam.md#list-view) view page:
...
Use the [global search](./user-interface-dam.md#global-search) if you wish to search globally across all the entities in the system.
...
![Search filters list](../../_assets/search-and-filtering/filters-list.jpg)
